...
@Composable
fun CameraScreen(onNavigateToProfileSettings: () -> Unit, dao: ProfileDao) {
                ...
                IconButton(
                    onClick = {
                        takePhoto(
                            controller,
                            { bitmap ->
                                val uri = saveImageLocally(context, bitmap)
                                if (uri != null) {
                                    dao.upsertProfile(
                                        Profile(
...
private fun saveImageLocally(context: Context, bitmap: Bitmap): Uri? {
